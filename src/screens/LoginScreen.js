  ...
  return ( 
    <div className="loginScreen">
        <div className="loginScreen__left">
                <Link to="/">
                   <img src="https://upload.wikimedia.org/wikipedia/en/thumb/d/d3/Starbucks_Corporation_Logo_2011.svg/
          ...
          <div className="loginScreen__inputContainer">
                ...
                <div className="loginScreen__joinNow">
                     <div className="loginScreen__joinNowContainer">
                         ...
                         <p>Join Starbucks Rewards to earn free food and drinks, get free
